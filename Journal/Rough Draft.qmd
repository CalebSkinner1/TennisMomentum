...
A more accurate estimate for the skill level of each player is the match's pre-match betting odds. The match's betting odds is a pre-match assessment of both player's likelihood of victory. Sportsbooks have the resources to develop highly advanced predictive models, and they have the incentives to react to recent results and developments much faster than a player's ranking. For strategic and personal reasons, certain players perform better on different tournaments. Betting odds can account for these nuances. I acquired the pre-match betting odds for each match from Tennis Data (Tennis Data, 2024). Tennis Data features betting odds from two different Sportsbooks: Bet365 and Pinnacles Sports.
...
Merriam-Webster Dictionary *cite* defines momentum as a "strength or force gained by motion or by a series of events." Likewise, I define the phenomenon of momentum as the direction and magnitude of an actor's performance at any instant in time. Thus, in tennis, momentum is a continuous measurement of a players' trajectory in a match. In this paper, I estimate this trajectory through the rate at which the player wins points. In tennis, players compete directly, so every victory for a player is a corresponding defeat for his or her opponent. Thus, the momentum estimations of two competing players is always equal and opposite. 

*reasoning for structure*

A strong player could secure a long streak of victories over a weaker player simply because he or she is a superior player (Page & Coates, 2017). Thus, without an appropriate adjustment for skill level, an analysis of momentum can falsely attribute positive momentum to a player that is simply more skillful than his or her opponent.

MODEL - isolate structure, take residuals
