...
ref_table <- tibble(
  key = colnames(prep_log_table(exist_momentum_men, exist_momentum_women, exist_momentum_combined, 1)),
  label = c("Term", "2.5%", "Odds Ratio", "97.5%", "2.5%", "Odds Ratio", "97.5%", "2.5%", "Odds Ratio", "97.5%"))

prep_log_table(exist_momentum_men, exist_momentum_women, exist_momentum_combined, 1) %>%
  rename(
   "2.5%" = "Combined_2.5%",
   "Odds Ratio" = "Combined_odds_ratio",
  "97.5%" = "Combined_97.5%",
   " 2.5% " = "Men_2.5%",
     " Odds Ratio " = "Men_odds_ratio",
  "97.5% " = "Men_97.5%",
     "  2.5%  " = "Women_2.5%",
     "  Odds Ratio  " = "Women_odds_ratio",
  " 97.5%" = "Women_97.5%") %>%
  # gt()
  flextable() %>%
  add_header_row(
  ...
  align(align = "center", part = "all") %>%
  width(j = 1, width = 1.06) %>%
  width(j = c(2,4,5,7,8), width = .38) %>%
  width(j = c(2,4,5,7,10), width = .42) %>%
